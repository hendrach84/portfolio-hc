...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
    <title>Portfolio Hendra Chayadi</title>
    <!--  FavIcon  -->
    ...
    <!-- Font Awesome -->
    <script src="https://kit.fontawesome.com/cce370e878.js" crossorigin="anonymous"></script>
  </head>
  <body class="max-width-d">
    ...
    <div class="left-side  nav-close">
      <div class="menu-content-align">
        <div class="left-side-image">
          <img src="assets/img/hc.png" alt="/">
        </div>
        <h1 class="mt-1">Hendra Chayadi</h1>
        ...
        <div class="container d-lg-none d-inline-block">
          <div class="row">
            <div class="col-12 text-center">
              <p class="text-muted mb-0">IT Programmer & Data Analyst</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <main id="main" class="main-2">
      ...
      <section id="hero" class="section hero w-100">
        <img class="extend-icon" src="assets/img/programming.jpg" height="300" width="300" alt="/">
            ...
            <div class="row">
              <div class="col-lg-12 text-center text-lg-start">
                ...
                <div class="hero-content mt-4 mx-auto mx-lg-0 text-lg-left mt-lg-none">
                  <p class="base-color">IT Programmer & Data Analyst</p>
                  <h2>Hello , I’m <span class="base-color">Hendra Chayadi </span>Welcome to My Website. </h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="about-boxes">
            <div class="row">
              <div class="col-lg-5">
                <div class="about-img">
                     <!-- https://via.placeholder.com/620x730 -->
                  <img src="assets/img/hc.png" alt="/">
              ...
              <div class="col-lg-7">
                <div class="about-description">
                  ...
                  <!--
                    Saya adalah seorang yang sangat menyukai dunia pemograman. 
                    Dikenal sangat ulet, tidak mudah menyerah, dan senang mempelajari hal-hal baru yang berhubungan dengan teknologi dan pemograman.
                    -->
                  <p class="about-text">
                    I am someone who really likes the world of programming.
                    Known to be very tenacious, doesn't give up easily, and enjoys learning new things related to technology and programming.
                    Apart from programming, I currently also have other skills as a data analyst. 
                  </p>
                </div>
                <!-- Personal Info -->
                <div class="row">
                  <div class="col-lg-6">
                    <ul class="list-unstyled personal-info">
                      <li>Email <span style="color: Mediumslateblue;"><i class="fa-regular fa-envelope"></i></span> : <small>hendrachayadi84@gmail.com</small>
                      </li>
                      <li>Phone <span style="color: LimeGreen;"><i class="fa-solid fa-square-phone"></i></span> : <small>+123 456 7890</small>
                      </li>
                      <li>City <span style="color: OrangeRed;"><i class="fa-solid fa-city"></i></span> : <small> DKI Jakarta, Indonesia</small>
                      </li>
                    </ul>
                  </div>
                  <div class="col-lg-6">
                    <ul class="list-unstyled personal-info">
                      <li>Age <span style="color: Indigo;"><i class="fa-solid fa-id-badge"></i></span> : <small>39</small>
                      </li>
                      <li>Degree <span style="color: DodgerBlue;"><i class="fa-solid fa-graduation-cap"></i></span> : <small>Bachelor of Computer Science</small>
                      </li>
                      <li>Job <span style="color: SandyBrown;"><i class="fa-solid fa-person-digging"></i></span> : <small>Online & Offline</small>
                      </li>
                    </ul>
                  </div>
                  <div class="col-12">
              ...
              <div id="skills">
                ...
                <div class="col-lg-12 skill-box">
                  <div class="skill-text">
                    ...
                    <div class="skill-bar-percent"><span data-from="0" data-to="90" data-speed="4000">90</span>%</div>
                  </div>
                ...
                <div class="col-lg-12 skill-box">
                  <div class="skill-text">
                    <div class="skillbar-title">JavaScripts</div>
                    <div class="skill-bar-percent"><span data-from="0" data-to="95" data-speed="4000">95</span>%</div>
                  </div>
                  <div class="skillbar clearfix" data-percent="95%">
                    <div class="skillbar-bar"></div>
            ...
            <div class="col-lg-5 ms-auto mt-5 mt-lg-0">
              ...
              <div class="language-bar">
                ...
                <div class="language-skill">
                  <h6 class="mb-0">Indonesia <span> Fluent</span>
                  </h6>
      ...
      <section id="resume" class="section">
        <div class="container">
          <!-- Servises -->
          <div class="services  mb-6 hide" style="display:none;">
            <div class="boxes">
          ...
          <div class="resume">
            ...
            <div class="boxes my-6">
              <h3 class="subtitle">Education <i class="fa-solid fa-graduation-cap"></i></h3>
              <div class="row vertical-line">
                <!--  Item 01  -->
                <div class="col-md-6">
                  <div class="timeline-box">
                    <div class="time-line-header">
                      <p class="timeline-year">2014 - 2018</p>
                      <h6 class="timeline-title">Bung Karno University - DKI Jakarta</h6>
                    </div>
                    <div class="timeline-content">
                      <p>Bachelor of Computer Science with GPA 3,31(Very Satisfactory) .</p>
                    </div>
                  </div>
                </div>
                <!--  Item 02  -->
                <div class="col-md-6">
                  <div class="timeline-box">
                    <div class="time-line-header">
                      ...
                      <h6 class="timeline-title">SMU Mangga Besar High School  - DKI Jakarta</h6>
                    </div>
                    <div class="timeline-content">
                      <p>SMU Mangga Besar High School Locate at DKI Jakarta.</p>
                    </div>
                  </div>
                </div>
                <!--  Item 03  -->
                <div class="col-md-6">
                  <div class="timeline-box">
                    <div class="time-line-header">
                      <p class="timeline-year">1998 - 2001</p>
                      <h6 class="timeline-title">SLTP Mangga Besar - DKI Jakarta</h6>
                    </div>
                    <div class="timeline-content">
                      <p>SLTP Mangga Besar Locate at DKI Jakarta.</p>
                    </div>
                  </div>
                </div>
                <!--  Item 04  -->
                <div class="col-md-6">
                  <div class="timeline-box">
                    <div class="time-line-header">
                      <p class="timeline-year">1991 - 1998</p>
                      <h6 class="timeline-title">SDN Taman Sari 07 PG - DKI Jakarta</h6>
                    </div>
                    <div class="timeline-content">
                      <p>SDN Taman Sari 07 PG Locate at DKI Jakarta .</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="boxes mt-6 mb-3">
              <h3 class="subtitle">Experience <i class="fa-solid fa-rectangle-list"></i></h3>
              <div class="row vertical-line">
                <!--   Item 01   -->
                <div class="col-md-6">
                  <div class="timeline-box">
                    <div class="time-line-header">
                      <p class="timeline-year">2019 - Now (PT. Valdo International)</p>
                      <h6 class="timeline-title">IT Programmer</h6>
                    </div>
                    <div class="timeline-content">
                      <p>
                        Monitor the system on the program, receive, design and test new system requests from clients. 
                        The program used is a PHP framework called CodeIgniter.
                        In there I was in charge of creating the backend, front-end, and reporting.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="timeline-box">
                    <div class="time-line-header">
                      <p class="timeline-year">2017 - 2019 (PT. Bangunan Jaya)</p>
                      <h6 class="timeline-title">Network and IT Support</h6>
                    </div>
                    <div class="timeline-content">
                      <p>
                        Network maintenance, if a problem is found, it must be done fix it as soon as possible.
                        Installing and testing network cables. 
                        Computer installation from assembly to ready to use.
                        Perform database backups regularly every day.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="timeline-box">
                    <div class="time-line-header">
                      <p class="timeline-year">2017 (PT. Abyaksa Wasa Aksata)</p>
                      <h6 class="timeline-title">IT Programmer</h6>
                    </div>
                    <div class="timeline-content">
                      <p>
                        Design the appropriate application system assigned by the leader.
                        Resolve debugging on the application system if found.
                        Receive requests for system changes to applications if requested.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="timeline-box">
                    <div class="time-line-header">
                      <p class="timeline-year">2004 - 2017 (PT. Bangunan Jaya)</p>
                      <h6 class="timeline-title">Administration Warehouse</h6>
                    </div>
                    <div class="timeline-content">
                      <p>
                        Monitor and check incoming and outgoing goods.
                        Monitor stock levels.
                        Request a PO for goods if they are no longer available.
                      </p>
                    </div>
                  </div>
                </div>
